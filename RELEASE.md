...
[![Release](https://img.shields.io/badge/v7.0.0-The%20Working%20Share-0969da?style=flat-square)](#-v700--the-working-share-three-ways)
...
Three archives, one version — `7.0.0` — and the tier lives in the **name**,
...
## 📦 v7.0.0 — The Working Share, three ways
...
`6.0.2`, `6.0.1`, `6.0.0` (the first CI-published release), the `5.x` and earlier
