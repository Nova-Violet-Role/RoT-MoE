...
lens activities off disk, computes an `R/s+` gauge from them, and **673
...
| Lean mutation suites | the theorems are load-bearing | **329 applied, 329 killed, 0 survived, 0 discarded** |
...
| **Router + Lean** | `rot-moe-0.9.1-lean.zip` | ⊕ `lean/` — 30 modules, 673 theorems, 27 mutation suites — ⊕ `checker/` (55 checkers) ⊕ `SETUP_LEAN` |
