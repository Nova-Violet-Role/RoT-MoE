...
lens activities off disk, computes an `R/s+` gauge from them, and **813
...
| Lean mutation suites | the theorems are load-bearing | **411 applied, 411 killed, 0 survived, 0 discarded** |
