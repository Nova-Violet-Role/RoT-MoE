...
lens activities off disk, computes an `R/s+` gauge from them, and **1048
...
| Lean mutation suites | the theorems are load-bearing | **591 applied, 591 killed, 0 survived, 0 discarded** |
...
| **Router + Lean** | `rot-moe-1.0.1-lean.zip` | ⊕ `lean/` — 55 modules, 1048 theorems, 52 mutation suites — ⊕ `checker/` (65 checkers) ⊕ `SETUP_LEAN` |
