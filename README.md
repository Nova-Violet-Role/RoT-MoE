...
lens activities off disk, computes an `R/s+` gauge from them, and **787
...
| Lean mutation suites | the theorems are load-bearing | **395 applied, 395 killed, 0 survived, 0 discarded** |
