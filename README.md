...
lens activities off disk, computes an `R/s+` gauge from them, and **710
...
| Lean mutation suites | the theorems are load-bearing | **348 applied, 348 killed, 0 survived, 0 discarded** |
...
| **Router + Lean** | `rot-moe-0.9.1-lean.zip` | ⊕ `lean/` — 32 modules, 710 theorems, 29 mutation suites — ⊕ `checker/` (55 checkers) ⊕ `SETUP_LEAN` |
