...
lens activities off disk, computes an `R/s+` gauge from them, and **1185
...
| Lean mutation suites | the theorems are load-bearing | **639 applied, 639 killed, 0 survived, 0 discarded** |
...
| **Router + Lean** | `rot-moe-1.0.1-lean.zip` | ⊕ `lean/` — 64 modules, 1185 theorems, 58 mutation suites — ⊕ `checker/` (68 checkers) ⊕ `SETUP_LEAN` |
