...
lens activities off disk, computes an `R/s+` gauge from them, and **1333
...
| Lean mutation suites | the theorems are load-bearing | **691 applied, 691 killed, 0 survived, 0 discarded** |
...
| **Router + Lean** | `rot-moe-1.0.1-lean.zip` | ⊕ `lean/` — 70 modules, 1333 theorems, 64 mutation suites — ⊕ `checker/` (69 checkers) ⊕ `SETUP_LEAN` |
