...
lens activities off disk, computes an `R/s+` gauge from them, and **567
...
| Lean mutation suites | the theorems are load-bearing | **261 applied, 261 killed, 0 survived, 0 discarded** |
...
| **Router + Lean** | `rot-moe-0.9.1-lean.zip` | ⊕ `lean/` — 23 modules, 567 theorems, 20 mutation suites — ⊕ `checker/` (47 checkers) ⊕ `SETUP_LEAN` |
