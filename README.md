...
lens activities off disk, computes an `R/s+` gauge from them, and **1058
...
| Lean mutation suites | the theorems are load-bearing | **601 applied, 601 killed, 0 survived, 0 discarded** |
...
| **Router + Lean** | `rot-moe-1.0.1-lean.zip` | ⊕ `lean/` — 56 modules, 1058 theorems, 53 mutation suites — ⊕ `checker/` (66 checkers) ⊕ `SETUP_LEAN` |
