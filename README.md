...
lens activities off disk, computes an `R/s+` gauge from them, and **703
...
| Lean mutation suites | the theorems are load-bearing | **344 applied, 344 killed, 0 survived, 0 discarded** |
...
* **`lean/Proofs/RotGates.lean`** (49 theorems) — **what may be deferred at a
...
| **Router + Lean** | `rot-moe-0.9.1-lean.zip` | ⊕ `lean/` — 32 modules, 703 theorems, 29 mutation suites — ⊕ `checker/` (55 checkers) ⊕ `SETUP_LEAN` |
