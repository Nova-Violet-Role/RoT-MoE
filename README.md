...
lens activities off disk, computes an `R/s+` gauge from them, and **483
...
| Lean mutation suites | the theorems are load-bearing | **212 applied, 212 killed, 0 survived, 0 discarded** |
...
| **Router + Lean** | `rot-moe-0.9.1-lean.zip` | ⊕ `lean/` — 22 modules, 483 theorems, 19 mutation suites — ⊕ `checker/` (47 checkers) ⊕ `SETUP_LEAN` |
