...
lens activities off disk, computes an `R/s+` gauge from them, and **648
...
| Lean mutation suites | the theorems are load-bearing | **317 applied, 317 killed, 0 survived, 0 discarded** |
...
| **Router + Lean** | `rot-moe-0.9.1-lean.zip` | ⊕ `lean/` — 28 modules, 648 theorems, 25 mutation suites — ⊕ `checker/` (55 checkers) ⊕ `SETUP_LEAN` |
