...
them, and **1695 machine-checked theorems in Lean 4** state what that gauge must
...
|---|---|---|
| Lean modules in `lean/Proofs/` | **92** | `ls lean/Proofs/*.lean \| wc -l` |
| theorems and lemmas proved | **1695** | `bash checker/count-theorems.sh lean/Proofs/*.lean` |
...
| The corpus is real | **MEASURED** | **92 modules**, **1695 theorems**, 77 mutation suites, **797 mutants applied, 797 killed, 0 survived, 0 discarded** |
