...
lens activities off disk, computes an `R/s+` gauge from them, and **637
...
| Lean mutation suites | the theorems are load-bearing | **311 applied, 311 killed, 0 survived, 0 discarded** |
...
| **Router + Lean** | `rot-moe-0.9.1-lean.zip` | ⊕ `lean/` — 27 modules, 637 theorems, 24 mutation suites — ⊕ `checker/` (55 checkers) ⊕ `SETUP_LEAN` |
