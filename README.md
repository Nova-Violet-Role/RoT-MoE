...
them, and **1679 machine-checked theorems in Lean 4** state what that gauge must
...
|---|---|---|
| Lean modules in `lean/Proofs/` | **91** | `ls lean/Proofs/*.lean \| wc -l` |
| theorems and lemmas proved | **1679** | `bash checker/count-theorems.sh lean/Proofs/*.lean` |
...
| The corpus is real | **MEASURED** | **91 modules**, **1679 theorems**, 77 mutation suites, **797 mutants applied, 797 killed, 0 survived, 0 discarded** |
