...
lens activities off disk, computes an `R/s+` gauge from them, and **956
...
| Lean mutation suites | the theorems are load-bearing | **535 applied, 535 killed, 0 survived, 0 discarded** |
...
| **Router + Lean** | `rot-moe-1.0.1-lean.zip` | ⊕ `lean/` — 50 modules, 956 theorems, 47 mutation suites — ⊕ `checker/` (63 checkers) ⊕ `SETUP_LEAN` |
