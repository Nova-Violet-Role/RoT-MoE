...
them, and **1724 machine-checked theorems in Lean 4** state what that gauge must
...
|---|---|---|
| Lean modules in `lean/Proofs/` | **95** | `ls lean/Proofs/*.lean \| wc -l` |
| theorems and lemmas proved | **1724** | `bash checker/count-theorems.sh lean/Proofs/*.lean` |
...
| `RoT-MoE-Router-Lean.zip` | adds `lean/` — the proof corpus and its mutation suites — plus `checker/` (84 checkers) and `SETUP_LEAN`, for re-proving every claim on your own machine |
...
| The corpus is real | **MEASURED** | **95 modules**, **1724 theorems**, 77 mutation suites, **797 mutants applied, 797 killed, 0 survived, 0 discarded** |
