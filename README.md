...
lens activities off disk, computes an `R/s+` gauge from them, and **802
...
| Lean mutation suites | the theorems are load-bearing | **403 applied, 403 killed, 0 survived, 0 discarded** |
