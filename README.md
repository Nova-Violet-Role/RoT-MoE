...
lens activities off disk, computes an `R/s+` gauge from them, and **1254
...
| Lean mutation suites | the theorems are load-bearing | **661 applied, 661 killed, 0 survived, 0 discarded** |
...
| **Router + Lean** | `rot-moe-1.0.1-lean.zip` | ⊕ `lean/` — 66 modules, 1254 theorems, 60 mutation suites — ⊕ `checker/` (68 checkers) ⊕ `SETUP_LEAN` |
