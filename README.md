...
lens activities off disk, computes an `R/s+` gauge from them, and **1394
...
| Lean mutation suites | the theorems are load-bearing | **717 applied, 717 killed, 0 survived, 0 discarded** |
...
| **Router + Lean** | `rot-moe-1.0.1-lean.zip` | ⊕ `lean/` — 74 modules, 1394 theorems, 68 mutation suites — ⊕ `checker/` (70 checkers) ⊕ `SETUP_LEAN` |
