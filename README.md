...
lens activities off disk, computes an `R/s+` gauge from them, and **611
...
| Lean mutation suites | the theorems are load-bearing | **293 applied, 293 killed, 0 survived, 0 discarded** |
...
* **`lean/Proofs/RotGates.lean`** (41 theorems) — **what may be deferred at a
  ...
  **In CI: nothing may be skipped.** Measured on run `31036112155` — which
...
| **Router + Lean** | `rot-moe-0.9.1-lean.zip` | ⊕ `lean/` — 24 modules, 611 theorems, 21 mutation suites — ⊕ `checker/` (47 checkers) ⊕ `SETUP_LEAN` |
