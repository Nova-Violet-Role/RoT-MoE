...
lens activities off disk, computes an `R/s+` gauge from them, and **832
...
| Lean mutation suites | the theorems are load-bearing | **431 applied, 431 killed, 0 survived, 0 discarded** |
...
| **Router + Lean** | `rot-moe-0.9.1-lean.zip` | ⊕ `lean/` — 33 modules, 787 theorems, 30 mutation suites — ⊕ `checker/` (56 checkers) ⊕ `SETUP_LEAN` |
