...
lens activities off disk, computes an `R/s+` gauge from them, and **1172
...
| Lean mutation suites | the theorems are load-bearing | **634 applied, 634 killed, 0 survived, 0 discarded** |
...
| **Router + Lean** | `rot-moe-1.0.1-lean.zip` | ⊕ `lean/` — 63 modules, 1172 theorems, 57 mutation suites — ⊕ `checker/` (68 checkers) ⊕ `SETUP_LEAN` |
