...
lens activities off disk, computes an `R/s+` gauge from them, and **825
...
| Lean mutation suites | the theorems are load-bearing | **423 applied, 423 killed, 0 survived, 0 discarded** |
