...
lens activities off disk, computes an `R/s+` gauge from them, and **741
...
| Lean mutation suites | the theorems are load-bearing | **366 applied, 366 killed, 0 survived, 0 discarded** |
...
| **Router + Lean** | `rot-moe-0.9.1-lean.zip` | ⊕ `lean/` — 33 modules, 741 theorems, 30 mutation suites — ⊕ `checker/` (56 checkers) ⊕ `SETUP_LEAN` |
