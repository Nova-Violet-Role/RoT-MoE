...
lens activities off disk, computes an `R/s+` gauge from them, and **1410
...
| Lean mutation suites | the theorems are load-bearing | **725 applied, 725 killed, 0 survived, 0 discarded** |
...
| **Router + Lean** | `rot-moe-1.0.1-lean.zip` | ⊕ `lean/` — 75 modules, 1410 theorems, 69 mutation suites — ⊕ `checker/` (71 checkers) ⊕ `SETUP_LEAN` |
