...
lens activities off disk, computes an `R/s+` gauge from them, and **593
...
| Lean mutation suites | the theorems are load-bearing | **280 applied, 280 killed, 0 survived, 0 discarded** |
...
| **Router + Lean** | `rot-moe-0.9.1-lean.zip` | ⊕ `lean/` — 24 modules, 593 theorems, 21 mutation suites — ⊕ `checker/` (47 checkers) ⊕ `SETUP_LEAN` |
