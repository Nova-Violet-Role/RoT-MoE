...
lens activities off disk, computes an `R/s+` gauge from them, and **495
...
| Lean mutation suites | the theorems are load-bearing | **221 applied, 221 killed, 0 survived, 0 discarded** |
...
| **Router + Lean** | `rot-moe-0.9.1-lean.zip` | ⊕ `lean/` — 22 modules, 495 theorems, 19 mutation suites — ⊕ `checker/` (47 checkers) ⊕ `SETUP_LEAN` |
