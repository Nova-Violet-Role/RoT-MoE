...
lens activities off disk, computes an `R/s+` gauge from them, and **1235
...
| Lean mutation suites | the theorems are load-bearing | **656 applied, 656 killed, 0 survived, 0 discarded** |
...
| **Router + Lean** | `rot-moe-1.0.1-lean.zip` | ⊕ `lean/` — 66 modules, 1235 theorems, 60 mutation suites — ⊕ `checker/` (68 checkers) ⊕ `SETUP_LEAN` |
