...
lens activities off disk, computes an `R/s+` gauge from them, and **1490
...
| Lean mutation suites | the theorems are load-bearing | **751 applied, 751 killed, 0 survived, 0 discarded** |
...
| **Router + Lean** | `rot-moe-1.0.1-lean.zip` | ⊕ `lean/` — 77 modules, 1490 theorems, 71 mutation suites — ⊕ `checker/` (71 checkers) ⊕ `SETUP_LEAN` |
...
```sh
claude --plugin-dir rot-moe-1.0.1-lean.zip
```
...
* `lean/Proofs/RotNullControl.lean` (11 theorems)
