...
lens activities off disk, computes an `R/s+` gauge from them, and **992
...
| Lean mutation suites | the theorems are load-bearing | **557 applied, 557 killed, 0 survived, 0 discarded** |
...
| **Router + Lean** | `rot-moe-1.0.1-lean.zip` | ⊕ `lean/` — 52 modules, 992 theorems, 49 mutation suites — ⊕ `checker/` (64 checkers) ⊕ `SETUP_LEAN` |
