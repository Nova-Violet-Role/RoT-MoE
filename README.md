...
them, and **1729 machine-checked theorems in Lean 4** state what that gauge must
...
| theorems and lemmas proved | **1729** | `bash checker/count-theorems.sh lean/Proofs/*.lean` |
...
| The corpus is real | **MEASURED** | **95 modules**, **1729 theorems**, 77 mutation suites, **797 mutants applied, 797 killed, 0 survived, 0 discarded** |
