...
lens activities off disk, computes an `R/s+` gauge from them, and **516
...
| Lean mutation suites | the theorems are load-bearing | **234 applied, 234 killed, 0 survived, 0 discarded** |
...
| **Router + Lean** | `rot-moe-0.9.1-lean.zip` | ⊕ `lean/` — 22 modules, 516 theorems, 19 mutation suites — ⊕ `checker/` (47 checkers) ⊕ `SETUP_LEAN` |
