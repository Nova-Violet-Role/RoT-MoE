...
them, and **1710 machine-checked theorems in Lean 4** state what that gauge must
...
|---|---|---|
| Lean modules in `lean/Proofs/` | **93** | `ls lean/Proofs/*.lean \| wc -l` |
| theorems and lemmas proved | **1710** | `bash checker/count-theorems.sh lean/Proofs/*.lean` |
...
| The corpus is real | **MEASURED** | **93 modules**, **1710 theorems**, 77 mutation suites, **797 mutants applied, 797 killed, 0 survived, 0 discarded** |
