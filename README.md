...
lens activities off disk, computes an `R/s+` gauge from them, and **968
...
| Lean mutation suites | the theorems are load-bearing | **546 applied, 546 killed, 0 survived, 0 discarded** |
