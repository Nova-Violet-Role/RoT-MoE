...
lens activities off disk, computes an `R/s+` gauge from them, and **684
...
| Lean mutation suites | the theorems are load-bearing | **335 applied, 335 killed, 0 survived, 0 discarded** |
...
| **Router + Lean** | `rot-moe-0.9.1-lean.zip` | ⊕ `lean/` — 31 modules, 684 theorems, 28 mutation suites — ⊕ `checker/` (55 checkers) ⊕ `SETUP_LEAN` |
