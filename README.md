...
lens activities off disk, computes an `R/s+` gauge from them, and **725
...
| Lean mutation suites | the theorems are load-bearing | **356 applied, 356 killed, 0 survived, 0 discarded** |
...
| **Router + Lean** | `rot-moe-0.9.1-lean.zip` | ⊕ `lean/` — 32 modules, 725 theorems, 29 mutation suites — ⊕ `checker/` (56 checkers) ⊕ `SETUP_LEAN` |
