...
lens activities off disk, computes an `R/s+` gauge from them, and **1293
...
| Lean mutation suites | the theorems are load-bearing | **670 applied, 670 killed, 0 survived, 0 discarded** |
...
| **Router + Lean** | `rot-moe-1.0.1-lean.zip` | ⊕ `lean/` — 67 modules, 1293 theorems, 61 mutation suites — ⊕ `checker/` (68 checkers) ⊕ `SETUP_LEAN` |
