...
lens activities off disk, computes an `R/s+` gauge from them, and **455
...
| Lean mutation suites | the theorems are load-bearing | **198 applied, 198 killed, 0 survived, 0 discarded** |
...
| **Router + Lean** | `rot-moe-0.8.1-lean.zip` | ⊕ `lean/` — 21 modules, 455 theorems, 18 mutation suites — ⊕ `checker/` (47 checkers) ⊕ `SETUP_LEAN` |
