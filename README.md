...
lens activities off disk, computes an `R/s+` gauge from them, and **1343
...
| Lean mutation suites | the theorems are load-bearing | **697 applied, 697 killed, 0 survived, 0 discarded** |
...
| **Router + Lean** | `rot-moe-1.0.1-lean.zip` | ⊕ `lean/` — 71 modules, 1343 theorems, 65 mutation suites — ⊕ `checker/` (69 checkers) ⊕ `SETUP_LEAN` |
