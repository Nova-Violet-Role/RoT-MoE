...
lens activities off disk, computes an `R/s+` gauge from them, and **660
...
| Lean mutation suites | the theorems are load-bearing | **323 applied, 323 killed, 0 survived, 0 discarded** |
...
| **Router + Lean** | `rot-moe-0.9.1-lean.zip` | ⊕ `lean/` — 29 modules, 660 theorems, 26 mutation suites — ⊕ `checker/` (55 checkers) ⊕ `SETUP_LEAN` |
