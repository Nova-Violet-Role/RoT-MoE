...
lens activities off disk, computes an `R/s+` gauge from them, and **1322
...
| Lean mutation suites | the theorems are load-bearing | **685 applied, 685 killed, 0 survived, 0 discarded** |
...
| **Router + Lean** | `rot-moe-1.0.1-lean.zip` | ⊕ `lean/` — 69 modules, 1322 theorems, 63 mutation suites — ⊕ `checker/` (69 checkers) ⊕ `SETUP_LEAN` |
