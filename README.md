...
lens activities off disk, computes an `R/s+` gauge from them, and **876
...
| Lean mutation suites | the theorems are load-bearing | **472 applied, 472 killed, 0 survived, 0 discarded** |
...
| **Router + Lean** | `rot-moe-1.0.1-lean.zip` | ⊕ `lean/` — 44 modules, 876 theorems, 41 mutation suites — ⊕ `checker/` (59 checkers) ⊕ `SETUP_LEAN` |
