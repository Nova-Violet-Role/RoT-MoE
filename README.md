...
lens activities off disk, computes an `R/s+` gauge from them, and **1447
...
| Lean mutation suites | the theorems are load-bearing | **737 applied, 737 killed, 0 survived, 0 discarded** |
...
| **Router + Lean** | `rot-moe-1.0.1-lean.zip` | ⊕ `lean/` — 76 modules, 1447 theorems, 70 mutation suites — ⊕ `checker/` (71 checkers) ⊕ `SETUP_LEAN` |
...
* `lean/Proofs/RotFamily.lean` (37 theorems)
