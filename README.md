...
lens activities off disk, computes an `R/s+` gauge from them, and **1030
...
| Lean mutation suites | the theorems are load-bearing | **579 applied, 579 killed, 0 survived, 0 discarded** |
...
| **Router + Lean** | `rot-moe-1.0.1-lean.zip` | ⊕ `lean/` — 54 modules, 1030 theorems, 51 mutation suites — ⊕ `checker/` (65 checkers) ⊕ `SETUP_LEAN` |
