...
lens activities off disk, computes an `R/s+` gauge from them, and **821
...
| Lean mutation suites | the theorems are load-bearing | **419 applied, 419 killed, 0 survived, 0 discarded** |
