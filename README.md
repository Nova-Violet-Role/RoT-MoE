...
lens activities off disk, computes an `R/s+` gauge from them, and **1433
...
| Lean mutation suites | the theorems are load-bearing | **733 applied, 733 killed, 0 survived, 0 discarded** |
...
| **Router + Lean** | `rot-moe-1.0.1-lean.zip` | ⊕ `lean/` — 76 modules, 1433 theorems, 70 mutation suites — ⊕ `checker/` (71 checkers) ⊕ `SETUP_LEAN` |
...
* `lean/Proofs/RotFamily.lean` (23 theorems)
