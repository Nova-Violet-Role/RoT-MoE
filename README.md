...
lens activities off disk, computes an `R/s+` gauge from them, and **1018
...
| Lean mutation suites | the theorems are load-bearing | **568 applied, 568 killed, 0 survived, 0 discarded** |
...
| **Router + Lean** | `rot-moe-1.0.1-lean.zip` | ⊕ `lean/` — 53 modules, 1018 theorems, 50 mutation suites — ⊕ `checker/` (65 checkers) ⊕ `SETUP_LEAN` |
